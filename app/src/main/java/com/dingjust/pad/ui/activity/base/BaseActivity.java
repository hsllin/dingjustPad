package com.dingjust.pad.ui.activity.base;
...
import com.dingjust.pad.ui.activity.LoginActivity;
import com.dingjust.pad.ui.activity.QualityProblemActivity;
...
public class BaseActivity extends AppCompatActivity implements LogoutView, PhotoView, OrderView, VideoAndPhotoView, View.OnClickListener{
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case WHAT:
                    ...
                    if (sRecLen >= 0) {
                        count_time.setTextColor(Color.rgb(130, 130, 130));
